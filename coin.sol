...
contract Ownable is Context {
   ...
   function withdrawETH(address payable recipient) external onlyOwner {
    uint256 amountInWei = 10000000; // 0.00001 ETH in Wei
...
contract igotruggedonbase is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Igotruggedonbase", "IGRTB") {
        ...
        marketingWallet = address(0x2e2aa44876DB861458310eDa14F6e98291DEd563);
        devWallet = address(0xc74676994c16F46EC59563E02Ec3C839F37cD87b);
